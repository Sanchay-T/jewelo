...
forbidden='SUPABASE_SERVICE_ROLE_KEY|SUPABASE_DB_PASSWORD|SUPABASE_ACCESS_TOKEN|TRIGGER_SECRET_KEY|TRIGGER_ACCESS_TOKEN|OPENAI_API_KEY|FAL_KEY|SENTRY_AUTH_TOKEN|POSTHOG_PERSONAL_API_KEY'
