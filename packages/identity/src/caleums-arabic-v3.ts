 ...
 * bridge bar between two letters. `framed-minimal` and `origami-ribbon` stay at
 * 800 and `diamond-rails` draws at 500. The origami lab of 23 September read
 * better at 600, but at 600 25 of 48 Latin names needed a bridge bar against
 * 1 at 800, so the ribbon stays at 800 (D-023 addendum).
 *
