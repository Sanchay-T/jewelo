...
export type PromptStageDefinition = {
  stageKey: string;
  stageType: "product_image" | "on_body_image" | "video_prompt" | "video_negative";
  branch: "always" | "has_reference" | "from_scratch";
  templateSlug: string;
  note?: string;
};

export const BASE_PROMPT_TEMPLATES: SeedTemplate[] = [
  {
    slug: "fromScratch",
...
export const BASE_PROMPT_PARTIALS: SeedPartial[] = [
  {
    slug: "textReference",
...
export const BASE_PROMPT_CONFIGS: SeedConfig[] = [
  {
    key: "fontStyles",
    data: {
...
export const BASE_PROMPT_PIPELINE_STAGES: PromptStageDefinition[] = [
  {
    stageKey: "product.reference",
    stageType: "product_image",
    branch: "has_reference",
    templateSlug: "reference",
    note: "Used when the design has a reference image or uploaded inspiration.",
  },
  {
    stageKey: "product.fromScratch",
    stageType: "product_image",
    branch: "from_scratch",
    templateSlug: "fromScratch",
    note: "Used when the design is generated without a visual reference.",
  },
  {
    stageKey: "onBody.chained",
    stageType: "on_body_image",
    branch: "always",
    templateSlug: "chainedOnBody",
    note: "Converts each successful product variation into an on-body render.",
  },
  {
    stageKey: "video.main",
    stageType: "video_prompt",
    branch: "always",
    templateSlug: "video",
    note: "Primary Veo prompt for the selected jewelry variation.",
  },
  {
    stageKey: "video.negative",
    stageType: "video_negative",
    branch: "always",
    templateSlug: "videoNegative",
    note: "Negative prompt paired with the main video stage.",
  },
];

export const REQUIRED_PROMPT_CONFIG_KEYS = BASE_PROMPT_CONFIGS.map((config) => config.key);

export const BASE_PIPELINE_SLUG = "core";
export const BASE_RELEASE_SLUG = "baseline";
