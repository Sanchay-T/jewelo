...
The pipeline exceeds normal web-request lifetimes and must survive browser closure, deploys, provider queues, callbacks, retries, and partial failure. Cloud Run request handlers create/authorize commands; Trigger jobs perform media work.
