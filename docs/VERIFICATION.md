...
If credentials are authorized, prove Cloud Run/Supabase/Trigger development or preview connections. If billing or a credential is the sole blocker, provide the exact one-time action without pretending the integration is verified.
