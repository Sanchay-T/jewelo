...
The executable master template and construction/view sections are in [compiler.mjs](../../scripts/prompt-lab/compiler.mjs). Exact compiled submissions, immutable references and results are in the [experiment gallery](../../reviews/2026-09-06-prompt-system/review.html). The [plain prompt package](../../reviews/2026-09-06-prompt-system/prompt-package.json) includes all variable definitions and interchangeable sections. Read the [qualification report](../../reviews/2026-09-06-prompt-system/report.md) for current measured status.
...
The [lab runbook](../../scripts/prompt-lab/README.md) defines budgets, reconciliation, preparation and review. The maximum staged campaign is 2,832 images, with two active tasks and a stop at 50 submissions while the suspected quota/reset remains unverified. Existing credits only.
