...
The fixed stack is Next.js 16.2/React 19 on Google Cloud Run Mumbai; pnpm/Turborepo; Supabase Mumbai for Postgres/Auth/Realtime/private Storage; Trigger.dev Cloud for durable jobs; direct OpenAI GPT Image 2 for stills; fal.ai for Seedance video inference; Seedance 2.0 Fast for four previews and Seedance 2.0 Standard for the selected final upgrade; Sentry/PostHog for observability.
