...
| --- | --- | --- | --- |
| D-001 | Next.js 16.2/React 19 on Google Cloud Run Mumbai | accepted by explicit user direction | measured hosting/runtime incompatibility |
...
| D-017 | All web environment values originate in Google Secret Manager; GitHub uses keyless OIDC | accepted | provider limitation or proved rotation/availability failure |
