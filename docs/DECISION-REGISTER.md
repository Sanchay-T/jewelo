...
Measured: yellow everywhere, and rose in all four constructions (`docs/goals/road-to-gold/lab-2026-09-24-free/ledger.md` rows 5, 11, 17 and 23, all pass; `lab-2026-09-24-free-route/ledger.md` line 22; the worn takes at `lab-2026-09-24-free-dependent/ledger.md` lines 54-55, where the rose was measured at hue 29-31 against 38-40 for yellow in the same scene).
White gold was never drawn from a free prompt, so it routes to the stencil (`metal_not_proven`), as does a specification with no `metalColor` at all.
