...
| Branch head | `main` contains the merged provider guard, all-look cleanup, prompt wording fix, and paid-validation handover updates; source branch `codex/overnight-launch-2026-09-08` remains at `b734e57` |
