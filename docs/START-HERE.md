...
Development uses Cloud Run staging, Supabase branches/persistent dev projects, Trigger.dev environments/preview branches, and development OpenAI/fal credentials. There is no required Docker or local infrastructure stack.
