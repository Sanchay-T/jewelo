...
const languages = [
  { code: "en", flag: "\u{1F1EC}\u{1F1E7}", name: "English", description: "Latin script names" },
  { code: "ar", flag: "\u{1F1E6}\u{1F1EA}", name: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629", description: "Arabic script names" },
  { code: "zh", flag: "\u{1F1E8}\u{1F1F3}", name: "\u4E2D\u6587", description: "Chinese characters" },
];
...
export default function LanguagePage() {
  ...
  return (
    <div className="bg-cream px-6 pb-24 lg:pb-8">
